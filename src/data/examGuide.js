    ...
    questionSteps: [
      {
        ...
        steps: [
          ...
          { insight: 'Check the utilization rate for EACH resource to identify the bottleneck and assess whether the system is sustainable.', dumb: 'Utilization = how hard each resource is working. Above 85% for humans is risky. At 100% for machines there is zero room for error. Check every resource, not just one.', work: '**Formula** $\\rho = \\frac{\\text{Demand}}{\\text{Resources} \\times \\text{Capacity per resource}}$\nwhere $\\rho$ = utilization (fraction of time the resource is busy)\n\n**Employees (17):**\nTotal employee capacity $= 17 \\times 6 = 102$ kits/shift\n$$\\rho = \\frac{100}{102} = 98\\%$$\n98% means employees are busy for 235 out of 240 minutes. One bathroom break or one missing screw and the whole shift falls behind.\n\n**Scales (5):**\nTotal scale capacity $= 5 \\times 24 = 120$ kits/shift\n$$\\rho = \\frac{100}{120} = 83\\%$$\n83% is acceptable. Scales have buffer for variability.\n\n**Sterilization units (25):**\nTotal sterilization capacity $= 25 \\times 4 = 100$ kits/shift\n$$\\rho = \\frac{100}{100} = 100\\%$$\n100% means every single machine must run perfectly with zero downtime. This is the bottleneck.\n\n**Which is the bottleneck?**\nSterilization — it needs the most units (25) and runs at 100%. Even one machine breaking means kits are not ready.\n\n**Safer plan — target 80-85% utilization:**\nEmployees: $100 / (20 \\times 6) = 83\\%$ → hire 20\nSterilization: $100 / (30 \\times 4) = 83\\%$ → buy 30 units\n\n**Sequencing constraint:**\nThe last employee finishes preparing a kit at 12:00. But sterilization takes 60 more minutes — so that kit is not done until 13:00. If everything must be done by 12:00, the last kit must ENTER sterilization by 11:00, which means the employee must finish preparing it by 11:00. This further increases the number of employees needed.', result: 'Minimum: 17 employees + 25 sterilizers. Recommended: ~20 employees + ~30 sterilizers (83% utilization). Bottleneck = sterilization.' },
        ],
      },
    ],
    takeaway: [
    ...
    questionSteps: [
      {
        ...
        steps: [
          { insight: 'First understand WHY the consultants proposed this. It is based on a real OM concept: inventory pooling. The math is correct — the problem is what the math does not capture.', dumb: 'The consultants did textbook supply chain optimization. On paper it is brilliant. In practice it destroyed the business because they forgot that distributors were not just moving boxes — they were making sales happen.', work: '**The consultant\'s rationale — inventory pooling**\n\nThe core idea: instead of 25 countries each holding their own safety stock, consolidate everything in one Brussels warehouse.\n\n**The pooling math:**\nEach country keeps: $SS_1 = z \\times \\sigma_1 \\times \\sqrt{VP}$\nAll 25 countries combined: $SS_{\\text{total}} = 25 \\times SS_1$\n\nBut if you pool demand in one warehouse:\n$\\sigma_{\\text{pooled}} = \\sqrt{25} \\times \\sigma_1 = 5 \\times \\sigma_1$\n(demand variability across countries partially cancels out — the square-root law)\n$SS_{\\text{pooled}} = z \\times 5\\sigma_1 \\times \\sqrt{VP} = 5 \\times SS_1$\n\n$25 \\times SS_1$ vs $5 \\times SS_1$ → pooling reduces safety stock by a factor of $\\sqrt{25} = 5$\n\nWith 4,000 SKUs and 400M average inventory, this could save hundreds of millions in working capital.', result: null },
          { insight: 'List ALL the pros systematically. The exam gives 30 points for this question — they want a thorough analysis, not a quick list.', dumb: 'Go through every possible advantage. The more you list with clear reasoning, the more points you get. Think about costs, operations, ethics, and data.', work: '**PRO 1: Lower inventory via pooling**\nSafety stock drops 5x (as shown above). With high-value medical devices, this frees up massive working capital.\n\n**PRO 2: Disintermediation**\nDistributors currently take 15% of the margin. Cutting them out means Medcorp keeps that 15%. On a business with 4,000 SKUs, this is significant revenue.\n\n**PRO 3: Transport economies of scale**\nOne logistics partner for all of Europe can negotiate better rates than 25 separate country-level arrangements.\n\n**PRO 4: Upstream simplification**\nShipping everything from the US factory to ONE warehouse in Brussels is simpler than shipping to 25 different country warehouses. Fewer customs processes, fewer shipping relationships.\n\n**PRO 5: Lower real estate costs**\nOne centralized warehouse replaces 25 country warehouses. Less total space needed (because of pooled inventory).\n\n**PRO 6: Ethical improvement**\nThe Spanish distribution relied on bribing hospital staff (Barca tickets, Hawaii trips). Centralizing removes Medcorp from this corrupt system.\n\n**PRO 7: Data and analytics**\nCentralized operations enable better demand forecasting and coordination across Europe.', result: null },
          { insight: 'Now list ALL the cons. This is where the exam differentiates good from great answers — most students get the pros but miss the deeper cons.', dumb: 'The consultants optimized costs but destroyed revenue. They forgot that in healthcare, relationships drive demand. You cannot replace a distributor who knows every surgeon personally with a FedEx driver.', work: '**CON 1: Loss of last-mile expertise**\nExpress carriers deliver to the hospital\'s logistics department. But surgical kits must go directly to the operating theater. You need to know the hospital layout, the schedules, which door to use. Distributors knew this; carriers do not.\n\n**CON 2: Loss of demand-driving relationships**\nDistributors were not just moving boxes — they were the sales force. They knew the surgeons personally, won competitive biddings, and drove demand. Removing them removes the demand engine.\n\n**CON 3: EU is not the US**\nEach European country has a different healthcare system, different regulations, different languages, different hospital cultures. A one-size-fits-all model from Brussels cannot serve Greece the same way it serves Germany.\n\n**CON 4: Longer and variable delivery times**\nFrom Brussels to Amsterdam = fast. From Brussels to a hospital in rural Portugal = much longer and less reliable than from a local Lisbon warehouse.\n\n**CON 5: Stakeholder alienation**\nDistributors are powerful stakeholders. Telling them they are no longer needed turns allies into enemies. Serveis Hospitalaris threatened to sue and defect to a competitor — and they were one of the best distributors.\n\n**CON 6: Implementation risk**\nRolling out simultaneously across all of Europe with no pilot is extremely risky. One country\'s failure cascades into all.\n\n**The result:** Sales in Spain dropped 60% in one month. A major competitive bidding was lost. The pooling savings (maybe 50-100M in working capital) cannot offset losing 60% of revenue.', result: 'The math was right but the strategy was wrong. Cost optimization that destroys demand is worse than no optimization at all.' },
          { insight: 'Explain Miguel\'s rationale — why he acted the way he did and whether it was justified.', dumb: 'Miguel saw the ship sinking, tried to warn the captain three times, got ignored, then grabbed the wheel himself. Right call? Depends on whether you think saving the business justifies breaking the rules.', work: '**Miguel\'s rationale:**\n\n1. He tried official channels FIRST — traveled to Boston 3 times to argue against Red Carpet\n2. Nobody listened — his boss said "my hands are tied"\n3. The Catalan distributor gave an ultimatum: reverse Red Carpet or they sue and defect\n4. Sales had already dropped 60% in one month\n5. He fabricated a fake export to divert inventory back to the old system\n6. One month later: sales fully recovered\n\n**Was he right?**\nOperationally: YES — sales recovered 100%, proving his market knowledge was correct\nEthically: NO — fabricating exports is fraud and a legal liability\nOrganizationally: DANGEROUS — if every employee bypasses HQ when they disagree, the company cannot function', result: null },
        ],
      },
      {
        question: 'What should the company do about Miguel?',
        steps: [
          { insight: 'This is worth 10 points and tests your ability to balance operational results against organizational ethics. The exam wants nuance, not a binary answer.', dumb: 'Do not just say fire him or keep him. Show you understand both sides. The best answer acknowledges his results, condemns his methods, and proposes systemic fixes.', work: '**Arguments FOR keeping Miguel:**\n- He tried proper channels first (3 trips to Boston) — he was not reckless from the start\n- His business judgment was proven correct — sales recovered 100%\n- He acted to save the company, not for personal gain\n- He has irreplaceable local market knowledge\n- Firing him would lose the one person who understood the Spanish market\n\n**Arguments AGAINST keeping Miguel:**\n- Fabricating a fake export is fraud — potential legal and regulatory consequences\n- Unilateral decisions undermine organizational authority\n- If tolerated, it sets a precedent: any employee can bypass HQ if they disagree\n- HQ may have had a longer-term strategy he was not aware of\n- The company cannot function if employees act as independent agents\n\n**The balanced recommendation:**\n1. Discipline Miguel but do NOT fire him — he demonstrated deep market knowledge the company desperately needs\n2. The company must acknowledge its own failure — they ignored repeated warnings from the field\n3. Implement a formal pilot process: test major operational changes in one country before rolling out to all 25\n4. Create feedback mechanisms so local employees can escalate concerns effectively\n\n**Real-life outcome:** Miguel was NOT fired. Red Carpet was discontinued. The company went back to the distributor model.', result: 'Discipline but keep Miguel. Fix the systemic problem: pilot changes locally before full rollout. Listen to field employees.' },
        ],
      },
    ],
    takeaway: [
    ...
    questionSteps: [
      {
        ...
        steps: [
          ...
          { insight: 'Compute safety stock and reorder point using the standard formulas.', dumb: 'Keep 5.5 million units as a buffer. When stock drops to 13.5 million, start a new batch. This covers the 20 days it takes to produce.', work: '**Formula** $SS = z \\times \\sigma_1 \\times \\sqrt{VP}$\nwhere $z = 3$ (99.87% SL), $\\sigma_1 = 2.24M$ units/month, $VP = 2/3$ months\n$$SS = 3 \\times 2.24M \\times \\sqrt{2/3} = 3 \\times 2.24M \\times 0.816 = 5.5M \\text{ units}$$\n\n**Formula** $ROP = \\bar{D}_1 \\times VP + SS$\nwhere $\\bar{D}_1 = 144M/12 = 12M$ units/month, $VP = 2/3$ months\n$$ROP = 12M \\times \\frac{2}{3} + 5.5M = 8M + 5.5M = 13.5M \\text{ units}$$\n\n**Policy statement:**\nWhenever inventory falls to 13.5M units, schedule production of one batch ($Q^* = 0.96M$ units).\nSafety stock of 5.5M covers the 20-day production window at 99.87% service level.', result: 'Policy: $Q^* = 0.96M$, $SS = 5.5M$, $ROP = 13.5M$ units.' },
        ],
      },
      {
    ...
    questionSteps: [
      {
        ...
        steps: [
          { insight: 'Calculate the financial opportunity. BIORISAN sells at 90/unit vs BIOTOPIN at 50/unit — nearly double the margin.', dumb: 'The partnership could generate billions. You would be crazy to say no outright.', work: '**Capacity per reactor** (from Part I):\n1 reactor produces $50{,}000 \\times 0.96 = 48{,}000$ L every 20 days\n$= 48{,}000 \\times 1000/50 = 960{,}000$ units per batch\n$= 960{,}000 \\times 365/20 = 17.52M$ units/yr per reactor\n\n**BIORISAN revenue from 4 reactors:**\n**Formula** Revenue $= \\text{units/yr per reactor} \\times \\text{reactors} \\times \\text{margin}$\nMargin per unit $= 90 - 10 = 80$ (selling price minus COGS)\n$$\\text{Revenue} = 17.52M \\times 4 \\times 80 = 5.6B \\text{/yr}$$\n\nEven if NEWBIO only gets 20% of the profit split: $5.6B \\times 0.20 = 1.12B$/yr.\nThis is an enormous opportunity that is very hard to refuse.', result: null },
          { insight: 'But giving up 4 reactors pushes BIOTOPIN utilization from 82% to 91% — dangerously high with no spare capacity.', dumb: 'Going from 82% to 91% means zero breathing room. One reactor breaks or demand spikes and you cannot fill orders for your core product.', work: '**Formula** $\\rho = D / \\text{Capacity}$\n\n**Current state (10 reactors for BIOTOPIN):**\nCapacity $= 10 \\times 17.52M = 175.2M$ units/yr\nDemand $= 144M$ units/yr\n$\\rho = 144/175.2 = 82\\%$ — healthy, with 3 spare reactors for emergencies\n\n**After partnership (9 reactors for BIOTOPIN):**\nCapacity $= 9 \\times 17.52M = 157.7M$ units/yr\n$\\rho = 144/157.7 = 91\\%$ — dangerously high!\n\nAt 91%: no spare capacity for:\n- Reactor maintenance (reactors need cleaning between batches)\n- Demand spikes (sales team wants to \"guarantee virtually all pick-ups\")\n- Emergency breakdowns\n- The 3 backup reactors are now ALL committed\n\nThe queueing lesson applies: at 91% utilization, any disruption cascades.', result: null },
          { insight: 'The answer is YES but with conditions. Accept the deal, mitigate the capacity risk, and protect the flagship product.', dumb: 'Say yes to the money, but immediately order new reactors and phase in slowly. Never sacrifice your core product for a partnership where you are the junior partner.', work: '**Recommendation: Accept with conditions**\n\n1. **Accept** the LC proposal — the revenue is too significant to pass up\n2. **Order 3+ new reactors immediately** — 30M each, 1-year delivery time\n3. **Phase in gradually:**\n   - Year 1: dedicate only 1-2 reactors to BIORISAN (manageable with 11-12 for BIOTOPIN at ~85%)\n   - Year 2: after new reactors arrive, commit full 4 reactors to BIORISAN\n4. **Protect BIOTOPIN** — it is the flagship product. NEWBIO is the \"junior partner\" in this deal (LC holds the BIORISAN patent). Do not compromise the supply chain of your own product for someone else\'s.\n5. **Negotiate the profit split carefully** — NEWBIO provides the manufacturing capacity (very expensive reactors), LC provides the IP. The split should reflect the capital investment.\n\n**Cost of new reactors:** 3 × 30M = 90M\n**Potential annual revenue:** even 20% of 5.6B = 1.12B/yr\nPayback period: less than 1 month. Clear yes.', result: 'Accept the partnership but order new reactors immediately and phase in over 2 years. Protect BIOTOPIN supply chain. Payback on new reactors < 1 month.' },
        ],
      },
    ],
    takeaway: [
    ...
    questionSteps: [
      {
        ...
        steps: [
          { insight: 'Follow the standard 4-step queueing analysis. First extract all parameters from the problem text.', dumb: 'Step by step: find the arrival rate, service rate, variability, utilization, then compute queue length and wait time.', work: '**Step 1: Parameters**\n$\\lambda = 3$ requests/hr (Poisson → $C_A = 1$)\n$t_S = 60$ min, $\\sigma_S = 15$ min → $\\mu = 1$/hr per engineer\n$C_S = \\sigma_S / t_S = 15/60 = 0.25$ (engineers are fairly consistent)\n$S = 4$ engineers, one shared queue\n\n**Step 2: Utilization**\n$$\\rho = \\frac{\\lambda}{S \\times \\mu} = \\frac{3}{4 \\times 1} = 0.75 = 75\\%$$\n\n**Step 3: Queue length**\n**Formula** $L_q = \\frac{\\rho^{\\sqrt{2(S+1)}}}{1-\\rho} \\times \\frac{C_A^2 + C_S^2}{2}$\n\nExponent: $\\sqrt{2(4+1)} = \\sqrt{10} = 3.16$\n$\\rho^{3.16} = 0.75^{3.16} = 0.405$\nVariability factor: $(1^2 + 0.25^2)/2 = 1.0625/2 = 0.531$\n$$L_q = \\frac{0.405}{0.25} \\times 0.531 = 1.62 \\times 0.531 = 0.856 \\text{ requests}$$\n\n**Step 4: Wait and total time**\n$W_q = L_q / \\lambda = 0.856 / 3 = 0.285$ hr $= 17.1$ min\n$W = W_q + t_S = 17.1 + 60 = 77.1$ min\n\n**Is this acceptable?** Fire danger increases after 1 hour (60 min) of overflow. Average total time is 77 min — meaning many requests exceed 60 min. This is dangerous.', result: 'Average wait = 17 min, total = 77 min. Exceeds the 60-min fire threshold. Current setup is risky.' },
        ],
      },
      {
        question: 'Alternative A: Add 1 engineer per shift (S = 5).',
        steps: [
          { insight: 'Same arrivals and service — just one more engineer. Watch how dramatically the nonlinear queueing effect reduces wait times.', dumb: 'One extra person drops the wait by 75%. This is the nonlinear magic of queues — small capacity changes near the danger zone have huge effects.', work: '**Same formula with $S = 5$**\n\n$\\rho = 3/(5 \\times 1) = 60\\%$ (was 75%)\n\nExponent: $\\sqrt{2(5+1)} = \\sqrt{12} = 3.46$\n$\\rho^{3.46} = 0.6^{3.46} = 0.181$\nVariability factor: same $0.531$\n$$L_q = \\frac{0.181}{0.4} \\times 0.531 = 0.453 \\times 0.531 = 0.226$$\n\n$W_q = 0.226 / 3 = 0.075$ hr $= 4.5$ min (was 17.1 min!)\n$W = 4.5 + 60 = 64.5$ min\n\n**Improvement:** $W_q$ dropped 74% (17.1 → 4.5 min) from adding just 1 engineer.\n**Cost:** 5 engineers/shift $\\times$ 3 shifts = 15 engineers total (was 12).\n**Concern:** Total time (64.5 min) still slightly above 60-min fire threshold.', result: '$W_q$ drops from 17 to 4.5 min. Total time 64.5 min — much safer but still slightly above the fire threshold.' },
        ],
      },
      {
        question: 'Alternative B: Replace engineers with a robot.',
        steps: [
          { insight: 'The robot changes TWO things at once: faster service ($t_S = 10$ min instead of 60) AND zero variability ($C_S = 0$ instead of 0.25). Both reduce queue length.', dumb: 'The robot is 6x faster AND perfectly consistent. The queue virtually disappears. Total resolution in 15 minutes instead of 77.', work: '**New parameters with robot**\n$S = 1$ (one robot replaces all engineers)\n$\\mu = 60/10 = 6$/hr (6x faster than an engineer)\n$C_S = 0$ (deterministic — no variability whatsoever)\n$C_A = 1$ (arrivals still Poisson)\n\n$\\rho = 3/(1 \\times 6) = 50\\%$\n\nExponent: $\\sqrt{2(1+1)} = \\sqrt{4} = 2$\n$\\rho^{2} = 0.5^{2} = 0.25$\nVariability factor: $(1^2 + 0^2)/2 = 0.5$ (half of normal because $C_S = 0$!)\n$$L_q = \\frac{0.25}{0.5} \\times 0.5 = 0.25 \\text{ requests}$$\n\n$W_q = 0.25 / 3 = 0.083$ hr $= 5$ min\n$W = 5 + 10 = 15$ min ← well below the 60-min fire threshold!\n\n**Cost comparison:**\nRobot costs 6x one engineer annually.\nCurrent: 4 engineers/shift $\\times$ 3 shifts = 12 engineers.\nRobot: 1 robot = 6 engineer-equivalents.\nRobot is CHEAPER than current setup (6 < 12) AND much safer (15 min vs 77 min).\n\n**But consider:** What if the robot breaks? No backup. What about reliability and maintenance?', result: 'Total time = 15 min (was 77). Robot is cheaper (6 vs 12 engineer-equivalents) AND safer. But single point of failure risk.' },
        ],
      },
      {
        question: 'Alternative C: Pool all 10 European centers.',
        steps: [
          { insight: 'Pool all 10 identical European centers into one virtual queue. Same 40 engineers total, same 30 requests/hr total — but one shared queue instead of 10 separate ones.', dumb: 'This is the most powerful option. Zero extra cost — just let any engineer serve any printer. The math shows why pooling is magic: same utilization, but the exponent in the formula grows with S, crushing the queue.', work: '**Pooling: 10 centers become 1**\n$S = 4 \\times 10 = 40$ engineers (same total staff)\n$\\lambda = 3 \\times 10 = 30$ requests/hr (same total demand)\n$\\mu = 1$/hr per engineer (unchanged)\n$C_A = 1$, $C_S = 0.25$ (unchanged)\n\n$\\rho = 30/(40 \\times 1) = 75\\%$ — exactly the same utilization!\n\n**Why does pooling help if utilization is the same?**\nThe exponent $\\sqrt{2(S+1)}$ grows with $S$:\n- Before: $\\sqrt{2 \\times 5} = 3.16$ → $0.75^{3.16} = 0.405$\n- After: $\\sqrt{2 \\times 41} = \\sqrt{82} = 9.06$ → $0.75^{9.06} = 0.0745$\n\nThe larger exponent crushes $\\rho$ down much further.\n\n$$L_q = \\frac{0.0745}{0.25} \\times 0.531 = 0.298 \\times 0.531 = 0.157$$\n\n$W_q = 0.157 / 30 = 0.00524$ hr $= 0.31$ min $= 19$ seconds!\n$W = 0.31 + 60 = 60.3$ min\n\n**Comparison of all 4 scenarios:**\nCurrent (4 eng): $W_q = 17.1$ min, $W = 77.1$ min\n+1 engineer (5): $W_q = 4.5$ min, $W = 64.5$ min\nRobot (1): $W_q = 5$ min, $W = 15$ min\nPooled (40): $W_q = 19$ sec, $W = 60.3$ min\n\n**Why pooling works here:** Engineers connect remotely — no language barrier, no physical presence needed. Any engineer in any country can reset any printer.', result: 'Pooling: $W_q$ drops from 17 min to 19 seconds with ZERO additional cost. This is the best option for reducing wait time. Combine with the robot for the ultimate solution.' },
        ],
      },
    ],
    takeaway: [
...
E. Shall IQ adopt a subscription model? (e.g., $30/month for 200 pages, $50 for 1000 pages, $15 for 50 pages — IQ provides the ink whenever the customer runs out)`,
    ...
    questionSteps: [
      ...
      },
      {
        ...
        steps: [
          { insight: 'Auto-replenishment means the printer monitors ink levels in real time and automatically orders when low. IQ controls the reorder point — the customer does not need to do anything.', dumb: 'The printer watches the ink level 24/7. When it drops below a threshold, it orders a new cartridge. The customer never runs out. IQ skips the retailer and ships directly.', work: '**Formula** $ROP = \\bar{D}_1 \\times VP + z \\times \\sigma \\times \\sqrt{VP}$\nwhere:\n$\\bar{D}_1$ = avg demand per period (200 pages/month)\n$VP$ = vulnerable period\n$z$ = safety factor\n$\\sigma$ = std dev of monthly demand (40 pages)\n\n**Finding VP:**\nThe printer monitors ink level continuously — this is continuous review.\nIn continuous review: $R = 0$ (no review gap), so $VP = LT$ only.\nAssume delivery takes 6 days via UPS/FedEx.\nIn months: $VP = LT = 6/30 = 0.2$ months\n\n**Finding z:**\nAssume high service level (99.87%, $z = 3$) — IQ wants customers to NEVER run out.\n\n**Calculating ROP:**\nExpected demand during VP: $\\bar{D}_1 \\times VP = 200 \\times 0.2 = 40$ pages\nSafety buffer: $z \\times \\sigma \\times \\sqrt{VP} = 3 \\times 40 \\times \\sqrt{0.2} = 3 \\times 40 \\times 0.447 = 53.6$ pages\n\n$$ROP = 40 + 53.6 \\approx 93 \\text{ pages remaining}$$\n\nWhen the printer detects ~93 pages worth of ink left (about half a cartridge), it automatically orders a replacement.', result: null },
